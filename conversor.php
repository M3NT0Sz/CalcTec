...
<body>
    ...
    <div class="div-conteudo">
        <form method="GET" action="logica/processamento.php">
            ...
            <select name="selectComprimentos">
                <option value="centimentrosParaMetros">Centímetros para Metros</option>
                <option value="metrosParaCentimetros">Metros para Centímetros</option>
